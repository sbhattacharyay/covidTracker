...
download.file(milken_vac_pdfLink,destfile = "milken_vaccine.pdf")
raw_text <- pdf_text("milken_vaccine.pdf")

out <- extract_tables(milken_vac_pdfLink,output = "data.frame")
vaccineData<-do.call(merge, list(out,all=TRUE))
