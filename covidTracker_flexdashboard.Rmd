...
italy_coords$Source <- rep("Ministry of Health of Italy",nrow(italy_coords))
...
covidData<-merge(jhuData,italy_coords,by = c("Province.State","Country.Region","Latitude","Longitude","Source"),all=TRUE)
```
